...
extension PhoneNumberError: LocalizedError {
    public var errorDescription: String? {
        switch self {
        case .generalError: return "An error occured while validating the phone number."
        case .invalidCountryCode: return "The country code is invalid."
        case .invalidNumber: return "The number provided is invalid."
        ...
        case .ambiguousNumber: return "Phone number is ambiguous."
        }
    }
}
